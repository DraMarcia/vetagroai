...
const DiagnosticoDiferencial = () => {
  ...
  const handleAnalyze = async () => {
    ...
    if (!symptoms.trim()) {
      toast({
        title: "Campo obrigatório",
        description: "Descreva os sinais clínicos observados.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const { data, error } = await supabase.functions.invoke("veterinary-consultation", {
        body: {
          ...
          context: "Diagnóstico diferencial veterinário baseado em sinais clínicos",
        },
      });
      ...
      <div className="grid gap-6 max-w-3xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Descreva detalhadamente os sinais clínicos observados
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <Textarea
                  id="symptoms"
                  placeholder="Ex: Cão, 5 anos, apresentando vômitos há 2 dias, anorexia, temperatura 39.5°C, desidratação moderada..."
                  value={symptoms}
